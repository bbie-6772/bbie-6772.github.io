...
- Payload - 유저 정보 (사망, 클리어 시)

| Field | Type | Description|
|---|---|---|
| userId | UUID | 유저의 고유 ID |
| nickname | UUID | 유저의 닉네임 |
| Score | INT | 유저의 점수 |
...
- 분석한 내용을 바탕으로 구조를 그려보았다.

![설계도 drawio (1)](https://github.com/user-attachments/assets/c2fb0a3b-8c2c-4976-8d34-b1db52365437)
