...
- 네트워크 계층 (3계층)
    ...
    인터넷에서는 인터넷 프로토콜 v4(IPv4) 및 IPv6가 주 네트워크 계층 프로토콜로 사용됨

- 전송 계층 (4계층)

    서로 다른 네트워크 간 통신 흐름을 관리하며 오류를 검출 및 복구하여 신뢰성을 체크

- 세션 계층 (5계층)

    통신 주체 간 연결의 시작,유지 및 종료하는 기능을 담당

- 표현 계층 (6계층)

    응용 프로그램이 데이터를 알맞게 표현할 수 있도록 변형 해주는 담당

- 응용 계층 (7계층)

    클라이언트의 요청 / 서버의 응답 의 형태를 지정해주는 계층 (표준화된 통신 방법과 관련)
