...
- 단위 원(Unit Circle)에서 각도와 호의 길이를 연결함
...
- 라디안은 원의 반지름(r)과 관련된 각의 단위

- 호의 길이가 반지름과 동일한 경우 그 각을 1라디안이라고 정의함

- 1 라디안은 약 57.3도(degree)에 해당하는 절대적인 각도 단위이며, 각도(degree)와 서로 변환할 수 있음
