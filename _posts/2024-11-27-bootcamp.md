...
banner:
  ...
  height: "50vh"
  min_height: "20vh"
tags: [Node.js, Express, Prisma, Algorithm, Backend, REST-API]
---
...
2. 보통의 Promise들은 변수에 대입하는 과정에서 await으로 실행이 되지만 map/reduce의 경우 콜백함수가 반복되며 반환된 값을 모아 최종 반환하기에.. 1차 반환된 Promise 들이 실행되지 않은 채 최종 반환에 모이는 것 같다.
